...
def create_and_write_file(xml_filename, final_path):
    ...
    with open(output_filename, 'w') as output_file:    
        for b  in info_dict['bboxes']:
            ...
            output_file.write("{} {:.3f} {:.3f} {:.3f} {:.3f}".format(0, b_center_x, b_center_y, b_width, b_height))
...
directory_path = './Y1.v2i.voc/test'
output_directory = './Y1.v2i.voc/yolo_labels_test'
